...
export const MOCK_PRODUCTS: Product[] = [
  ...
  // WOMEN'S CLOTHING
  { id: 15, title: "Women's Snowboard Jacket", price: 56.99, description: "Jacket", category: "women's clothing", image: "https://images.unsplash.com/photo-1551488831-00ddcb6c6bd3?q=80&w=800", rating: { rate: 2.6, count: 235 } },
  { id: 16, title: "Women's Leather Jacket", price: 29.95, description: "Jacket", category: "women's clothing", image: "https://images.unsplash.com/photo-1551028719-00167b16eac5?q=80&w=800", rating: { rate: 2.9, count: 340 } },
  { id: 17, title: "Rain Jacket Women", price: 39.99, description: "Jacket", category: "women's clothing", image: "https://images.unsplash.com/photo-1544022613-e87ca75a784a?q=80&w=800", rating: { rate: 3.8, count: 679 } },
